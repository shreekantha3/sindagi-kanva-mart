# Kanva Mart — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-kanva-mart/
- **Repo:** `shreekantha3/sindagi-kanva-mart` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-kanva-mart/'` for GitHub Pages project-site hosting.
